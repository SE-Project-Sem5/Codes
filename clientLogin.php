...
<body>
    ...
    <div style="margin-top: 40px; margin-left: 580px;">
        <span style="font-family: 'Kalam'; font-size: 40px; line-height: 50px; color: #77920D;">Login</span><br>
        <a href="adminLogin.php" style="color:#77920D; padding-left: 85px;">Admin Login</a>
    </div>
    <div>
    <form class="container" action="clientLogin.php" method="post">
        ...
        <button type="submit" style="border-radius: 15px; height: 50px; width: 270px; background: #77920D; color: white; font-size: 20px;" id="button">Login</button><br><br>
        <a href="signUp.php" style="color:#77920D">Sign Up</a><a href="#" style="margin-left: 90px; color: #77920D;">Forgot Password?</a>
      </form>
    </div>
</body>
</html>